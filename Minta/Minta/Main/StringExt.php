<?php
	...
	class Minta_Main_StringExt extends Minta_Main_Class {
		public function __construct(){
			parent::__construct();
		}
		public function toString(){
			$this->text = "Extends String Class";
			return $this->text;
		}
		public function html_encode($t=""){
		...
		public function toNormalString( $text )
		{
		...
		public function s_toNormalString ( $alias )
		{
		    $alias = $this->toNormalString( $alias );
